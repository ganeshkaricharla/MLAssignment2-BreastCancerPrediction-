...
from config import LR_MAX_ITERATION, RANDOM_STATE
...
if __name__ == "__main__":
    ...
    lr.train()
    y_pred, y_pred_proba = lr.predict()
    metrics = lr.metrics(y_pred=y_pred, y_pred_proba=y_pred_proba)
    confusion_matrix = lr.get_confusion_metrics(y_pred=y_pred)
    classification_report = lr.get_classification_report(y_pred=y_pred)
